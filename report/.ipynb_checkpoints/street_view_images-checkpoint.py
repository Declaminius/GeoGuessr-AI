...
def generate_images(country, number_of_total_locations, proportional_to_network_size = True):
    ...
    for state in states_dict[country]:
        ...
        print(f"""{num_images_after - num_images_before} images of {number_of_locations_state} locations found in {state}. 
              In total now {num_images_after} images in {state}.""")
